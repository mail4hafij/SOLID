...
namespace SRC.HelloWorld
{
    public class HelloWorldUnitOfWork : IHelloWorldUnitOfWork
    {
        ...
        private IHelloWorldDatabaseService _databaseService { get; set; }
        ...
        public HelloWorldUnitOfWork(IHelloWorldDatabaseService databaseService)
        {
            _disposed = false;
        ...
        public void Begin()
        {
            ...
            Context = new HelloWorldContext(Connection);
